...
class Dataset:
    def __init__(self,
                 ...
                 preprocessing_folder='/home/sysadm/Dipan/LV_Seg/EDPCNN-master-20210621T060724Z-001/',
                 drive_data_folder='/content/drive/MyDrive/LV_Seg/EDPCNN-master-20210621T060724Z-001', 
                 train_set_size=1000000, valid_set_size=1000000,
                 num_cls=1, unet=None, remove_nan_center=True):

        #print("hhhhhhekllllooooooo")
        if isdrive :
          data_file_path = data_file_path = os.path.join(drive_data_folder, "data_2D_size_212_212_res_1.36719_1.36719.hdf5")
        else:
...
if __name__ == "__main__":
    ...
    plt.savefig("visualize/mask.jpg")
