...
def parse_args():
    ...
    parser.add_argument('--val_eval_freq', default=50, type=int)
    parser.add_argument('--train_set_sz', default=1516, type=int)
...
#         eval_loss_list.append(eval_loss)
    ...
    with open("log/unet-1_cls/train_loss.txt",'wb') as tf1:
        _pickle.dump(train_loss_list,tf1)
        
    with open("log/unet-1_cls/train_dice.txt",'wb') as tf2:
        _pickle.dump(train_dice_scores,tf2)
        
    with open("log/unet-1_cls/eval_dice.txt.txt",'wb') as tf3:
        _pickle.dump(eval_dice_scores,tf3)
